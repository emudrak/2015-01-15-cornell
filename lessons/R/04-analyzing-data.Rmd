...
> * generate plots from the data using the average weights of the animals as an
>   example
...
**Note**: 
What this is actually doing is rather interesting.  The simple line
...
```{r, echo=FALSE}
paste(c(complete.cases(surveys)[1:30], "..."))
```
...
The best way to develop insight is often to visualize
...
```{r, purl=FALSE, fig.height=4, fig.width=4}
...
Previous:[The data.frame class](03-data-frames.html) Next: [Writing Functions](05-func-R.html)
